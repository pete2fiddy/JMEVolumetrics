...
import defunct.segment.SelectionDisabledSegmenter;
import defunct.segment.SimilarityThresholdedFloodfillCloudSegmenter;
...
public class SegmenterControllerImpl implements SegmenterController, java.awt.event.ActionListener {
    ...
    private Camera cam;
    private InteractivePointCloudManipulator cloudController;
    ...
    */
    public SegmenterControllerImpl(InputManager inputManager, Camera cam, InteractivePointCloudManipulator cloudController) {
