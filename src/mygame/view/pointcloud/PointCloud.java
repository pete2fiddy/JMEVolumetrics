...
public class PointCloud {
    ...
    */
    ...
    public CloudPoint[] getPointClones(int... indices) {
        CloudPoint[] out = new CloudPoint[indices.length];
        for(int i = 0; i < indices.length; i++) {
            out[i] = points[indices[i]].copy();
        }
        return out;
    }
    
    public void setPoint(int index, CloudPoint point) {
        points[index] = point;
    }
    
    public CloudPoint[] getPointClones() {
        CloudPoint[] out = new CloudPoint[points.length];
